...
/**
 * org.dhhs.dirm.acts.cs.util.ErrorDescriptor
 *
 ...
 * 
 * It is recommended that the class or method that actually instantiates
 * this object pass the fully qualified classname, method name and object 
 * details from the catch block.
 *
 * Notification and Logging is turned on by default. If for whatever reason,
 * you decide not to notify and/or log this error, call the appropriate
 ...
 * </pre> 
 * 
 * New Hire Application from Systems Research & Development Inc (http://www.sysrad.com))
 * 
 * Licensed Materials - Property of Systems Research & Development Inc.
 * 
 * Copyright (C) 2001 Systems Research & Development, Inc. All Rights Reserved
 *
 * Creation date: (3/28/2002 11:08:32 PM)
 ...
 * Creation date: (3/28/2002 11:30:46 PM)
 * @param errClass java.lang.String
 * @param errMethod java.lang.String
 */
...
/**
 * Constructor that requires class, method, message & error object to 
 * debug the exception
 *
 * It is recommended that the classname be fully qualified
 * example: com.foo.bar if bar the class in the package com.foo.bar
 *
 * Creation date: (3/28/2002 11:32:06 PM)
 * @param errClass java.lang.String
 * @param errMethod java.lang.String
 * @param errMessage java.lang.String
 * @param errObject java.lang.Object
 */
...
/**
 * This method provides the ability to add any supporting debug data
 * that helps the application programmer or administrator identify
 * the source of an exception.
 *
 * String that is passed to this method may contain any JavaBeans,
 * or any other information but preferable in a formatted way with
 * each name value pair followed with a newline character
 *
 ...
 *
 * Creation date: (3/28/2002 11:29:22 PM)
 */
...
/**
 * Returns the vector of debug strings that have been passed by the
 * class that instantiated the object
 *
...
/**
 * Returns the fully qualified classname that has been passed by the
 * class that instantiated the object
 *
...
/**
 * Returns the error Level that has been passed by the
 * class that instantiated the object
 *
 * Creation date: (3/28/2002 11:33:11 PM)
 * @return int
...
/**
 * Returns the error message that has been passed by the
 * class that instantiated the object
 *
 * Creation date: (3/28/2002 11:33:11 PM)
 * @return java.lang.String
...
/**
 * Returns the error method that has been passed by the
 * class that instantiated the object
 *
 * Creation date: (3/28/2002 11:33:11 PM)
 * @return java.lang.String
...
/**
 * Returns the error object details that has been passed by the
 * class that instantiated the object
 *
 * Creation date: (3/28/2002 11:33:11 PM)
 ...
 * Creation date: (4/8/2002 1:02:05 PM)
 * @param newAppVariables java.util.Vector
 */
 ...
 *
 * Creation date: (3/28/2002 11:33:11 PM)
 * @param newErrClass java.lang.String
 */
 ...
 *
 * Creation date: (3/28/2002 11:33:11 PM)
 * @param newErrLogRequired boolean
 */
 ...
 *
 * Creation date: (3/28/2002 11:33:11 PM)
 * @param newErrMessage java.lang.String
 */
public void setErrMessage(java.lang.String newErrMessage) {
	errMessage = newErrMessage;
}
/**
 * Method that is used to set method of the class where the exception occurred.
 *
 * Creation date: (3/28/2002 11:33:11 PM)
 * @param newErrMethod java.lang.String
 */
 ...
 *
 * Creation date: (3/28/2002 11:33:11 PM)
 * @param newErrObject java.lang.Object
 */
