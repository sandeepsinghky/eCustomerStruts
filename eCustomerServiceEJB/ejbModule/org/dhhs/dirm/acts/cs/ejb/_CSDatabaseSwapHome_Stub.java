...
public class _CSDatabaseSwapHome_Stub extends Stub implements CSDatabaseSwapHome {
    
    private static final String[] _type_ids = {
        "RMI:org.dhhs.dirm.acts.cs.ejb.CSDatabaseSwapHome:0000000000000000", 
    ...
    public CSDatabaseSwap create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (CSDatabaseSwap) in.read_Object(CSDatabaseSwap.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",org.dhhs.dirm.acts.cs.ejb.CSDatabaseSwapHome.class);
            if (so == null) {
                return create();
            }
            try {
                CSDatabaseSwap result = ((org.dhhs.dirm.acts.cs.ejb.CSDatabaseSwapHome)so.servant).create();
                return (CSDatabaseSwap)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
