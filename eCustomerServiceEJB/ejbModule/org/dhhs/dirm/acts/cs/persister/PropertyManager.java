...
/**
 * A Generic Property Manager Class that helps all the
 * servlets to obtain email and ip configurations
 * <p>
 ...
 * Note:
 * 
 * Rama 03/05/03. Modified the Logic in the PropertyManager class. Always call loadXXX method
 * from the Caller passing the String full absolute file name.
 * <p>
...
public class PropertyManager {
	...
	static int dbTimeToWait = 0; // No Wait
	...
	private static final String DB_CONFIG_BUNDLE_NAME = "EJBDataSource.properties";
	...
	public PropertyManager() {
		...
		System.out.println("EJB Container PropertyManager (path): " + fullPath); 		
		
		try {	
			loadAppProperties(fullPath);
			loadDBProperties(fullPath);
		} catch (Exception e) {
			e.printStackTrace();
		}
		 ...
		 */
		if (path != null) {
			PropertyConfigurator.configure(fullPath + System.getProperty("file.separator") +"log4j.properties");
		}
	...
	public static void loadAppProperties(String fileName) throws Exception {
		...
		/** 
		* Get information at runtime from an external property file identified by fileName parameter.
		* 
		*/
	...
	public static void loadDBProperties(String fileName) throws Exception {
		...
		* identified by fileName) about the server,user, password,
		...
		*/
		...
		/**
		 * New Logic 07/16/04 - Implement a new HitJDBC Datasource for this EJB so that
		 * we do not have a conflict with the WebApplication
		 */
		new DataSourceAdmin();
	 ...
	 * Creation date: (4/16/2002 8:55:35 AM)
	 * @return int
	 */
	...
	/**
	 * Insert the method's description here.
	 * Creation date: (4/16/2002 3:11:52 PM)
	 * @return int
	 */
	...
	/**
	 * Insert the method's description here.
	 * Creation date: (11/30/2001 3:54:49 PM)
	 ...
	 * Insert the method's description here.
	 * Creation date: (4/16/2002 8:55:35 AM)
	 * @param newDbClassificationToWait int
	 */
	 ...
	 * Insert the method's description here.
	 * Creation date: (4/16/2002 3:11:52 PM)
	 * @param newMsClassificationToWait int
	 */
	 ...
	 * Insert the method's description here.
	 * Creation date: (11/30/2001 3:54:49 PM)
	 * @param newOtherEmail java.lang.String
	 */
	 ...
	 * Insert the method's description here.
	 * Creation date: (11/30/2001 3:54:49 PM)
	 * @param newOtherURL java.lang.String
	 */
	 ...
	 * Insert the method's description here.
	 * Creation date: (11/30/2001 3:54:49 PM)
	 * @param newPrimaryEmail java.lang.String
	 */
	 ...
	 * Insert the method's description here.
	 * Creation date: (11/30/2001 3:54:49 PM)
	 * @param newPrimaryURL java.lang.String
	 */
	 ...
	 * Insert the method's description here.
	 * Creation date: (11/30/2001 3:54:49 PM)
	 * @param newSecondaryEmail java.lang.String
	 */
	 ...
	 * Insert the method's description here.
	 * Creation date: (11/30/2001 3:54:49 PM)
	 * @param newSecondaryURL java.lang.String
	 */
	 ...
	 * @param commitSelect The commitSelect to set
	 */
	 ...
	 * @param emailMsgLevel The emailMsgLevel to set
	 */
	 ...
	 * @param emailMsgNotify The emailMsgNotify to set
	 */
	...
	/**
	 * Sets the instantMsg.
	 * @param instantMsg The instantMsg to set
	 */
	 ...
	 * @param instantMsgLevel The instantMsgLevel to set
	 */
	 ...
	 * @param instantMsgNotify The instantMsgNotify to set
	 */
	...
	/**
	 * Sets the rdbName.
	 * @param rdbName The rdbName to set
	 */
	 ...
	 * @param backupRegion The backupRegion to set
	 */
	 ...
	 * @param queryRegion The queryRegion to set
	 */
	...
	/**
	 * Sets the webRegion.
	 * @param webRegion The webRegion to set
	 */
	 ...
	 * @param autoCreatePkgs The autoCreatePkgs to set
	 */
	 ...
	 * @param remoteMonitorAddr The remoteMonitorAddr to set
	 */
