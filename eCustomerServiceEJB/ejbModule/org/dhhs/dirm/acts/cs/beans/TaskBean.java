...
public class TaskBean {
	...
	/**
	 * MOD # 2872 - 09/07/2004. Agents should be able to search on any of the filter criteria
	 * even though the task might belong to someone else.
	 */
