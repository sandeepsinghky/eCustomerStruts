...
<%
//	request.setAttribute("page","processTypes");
	request.setAttribute("page","ProcessSearchAction");
%>		

<tiles:insert page="layout.jsp" flush="true">
	<tiles:put name="title" value="eCSTS Process Types" />
	...
	<tiles:put name="body" type="string" >
		...
		<DIV id="errorheader"><logic:messagesPresent>
			...
			<DIV id="form">
				<fieldset><legend>eCSTS Process Types</legend>
					<layout:collection name="stepslist" styleClass="FORM" styleClass2="FORM2" sortAction="client" title="" >
						...
						<layout:collectionItem title="Modify" property="" url="ManageProcessAction.do?reqCode=edit&step=" param="step"><img src="images/edit.gif" border="0"></layout:collectionItem>
						<layout:collectionItem title="Details" property="" url="ManageProcessAction.do?reqCode=view&step=" param="step"><img src="images/view.gif" border="0"></layout:collectionItem>
					</layout:collection>
					<%-- Add the Buttons --%>
					<div class="row">
					...
					<div class="row">
						...
						<span class="button"><html:button property="New Process Type" onclick="window.location.href='ManageProcessAction.do?reqCode=create';"><bean:message key="button.addNewProcess"/></html:button></span>
					</div>
