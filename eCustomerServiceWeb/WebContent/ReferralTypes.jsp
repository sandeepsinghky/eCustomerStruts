...
<%
	request.setAttribute("page","ReferralSearchAction");
%>		

<tiles:insert page="layout.jsp" flush="true">
	<tiles:put name="title" value="eCustomer Service Referral Types" />
	...
	<tiles:put name="body" type="string" >
		...
		<DIV id="pagetitle">
			<h1>eCustomer Service Referral Types</h1>
		</DIV>
		<DIV id="pagebody">
			<p>Here is a list of valid referral types applicable for this application.</p>
		...
		<DIV id="errorheader"><logic:messagesPresent>
			...
			<DIV id="form">
				<fieldset><legend>eCSTS Referral List</legend>
					<layout:collection name="formslist" styleClass="FORM" styleClass2="FORM2" sortAction="client" title="" >
						<layout:collectionItem title="Referral Type" property="type" sortable="true"/>
						<layout:collectionItem title="Referral Description"  property="description" sortable="true"/>
						...
						<layout:collectionItem title="Modify" property="" url="ManageReferralAction.do?reqCode=edit&type=" param="type"><img src="images/edit.gif" border="0"></layout:collectionItem>
						<layout:collectionItem title="Details" property="" url="ManageReferralAction.do?reqCode=view&type=" param="type"><img src="images/view.gif" border="0"></layout:collectionItem>
					</layout:collection>
					<%-- Add the Buttons --%>
					<div class="row">
					...
					<div class="row">
						...
						<span class="button"><html:button property="NewReferralType" onclick="window.location.href='ManageReferralAction.do?reqCode=create';">New Referral Type</html:button></span>
					</div>
