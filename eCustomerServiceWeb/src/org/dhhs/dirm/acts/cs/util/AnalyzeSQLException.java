...
/**
 * An Exception Class that can handle exceptions that occur during communication
 * of JDBC Driver with DB2 on OS390 Creation date: (10/30/2001 5:57:59 PM)
 * 
...
public class AnalyzeSQLException
{
	...
	/**
	 * Constructor that accepts the SQLException Object Creation date:
	 * (10/30/2001 5:58:38 PM)
	 * 
	 * @param e
	...
	/**
	 * A method that decides if the exception is a driver exception Creation
	 * date: (10/30/2001 6:13:31 PM)
	 * 
	 * @return boolean
	 */
	...
	/**
	 * A method that decides if the exception is a socket exception Creation
	 * date: (10/30/2001 6:08:21 PM)
	 * 
	 * @return boolean
	 */
	...
	/**
	 * A method that decides if an exception is a generic sql exception Creation
	 * date: (10/30/2001 6:03:45 PM)
	 * 
	 * @return boolean
	 */
